...
def test_gate3b_local_report_does_not_import_runner_or_live_surfaces() -> None:
...
if loaded:
    raise AssertionError(f"Gate 3B local report loaded forbidden modules: {loaded}")
"""
    )
...
def test_gate3b_local_report_source_has_no_shell_or_code_execution_helpers() -> None:
