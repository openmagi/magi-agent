...
PR6_CURRENT_SLICE_REFS = {
    "openmagi_core_agent/harness/memory_write.py",
    "openmagi_core_agent/harness/memory_compaction.py",
    "tests/test_memory_write_compaction_boundary.py",
}
PR7_CURRENT_SLICE_REFS = {
    "openmagi_core_agent/missions/__init__.py",
    "openmagi_core_agent/missions/lifecycle.py",
    "openmagi_core_agent/missions/receipts.py",
    "tests/test_mission_lifecycle_state_machine.py",
}
PR8_CURRENT_SLICE_REFS = {
    "openmagi_core_agent/missions/cron_policy.py",
    "openmagi_core_agent/missions/scheduler_adapter.py",
    "tests/test_cron_scheduler_mutation_boundary.py",
}
PR9_CURRENT_SLICE_REFS = {
    "openmagi_core_agent/runtime/long_running_activity.py",
    "openmagi_core_agent/runtime/receipt_utils.py",
    "openmagi_core_agent/missions/background_tasks.py",
    "tests/test_background_task_activity_boundary.py",
}
PR10_CURRENT_SLICE_REFS = {
    "openmagi_core_agent/missions/events.py",
    "openmagi_core_agent/transport/sse.py",
...
PR11_CURRENT_SLICE_REFS = {
    "openmagi_core_agent/self_improvement/__init__.py",
    "openmagi_core_agent/self_improvement/eval_capture.py",
    "openmagi_core_agent/self_improvement/failure_cluster.py",
    "tests/test_self_improvement_eval_capture.py",
}
PR12_CURRENT_SLICE_REFS = {
    "openmagi_core_agent/recipes/first_party/self_improvement.py",
    "openmagi_core_agent/self_improvement/__init__.py",
    "openmagi_core_agent/self_improvement/proposals.py",
    "tests/test_self_improvement_proposal_recipe.py",
}
PR13_CURRENT_SLICE_REFS = {
    "openmagi_core_agent/self_improvement/__init__.py",
    "openmagi_core_agent/self_improvement/review_gate.py",
    "openmagi_core_agent/self_improvement/promotion_gate.py",
    "tests/test_self_improvement_review_promotion_gate.py",
}
PR14_CURRENT_SLICE_REFS = {
    "openmagi_core_agent/self_improvement/__init__.py",
    "openmagi_core_agent/self_improvement/rollback.py",
    "openmagi_core_agent/self_improvement/drift_watch.py",
...
def test_runtime_code_diff_stays_within_final_review_fix_slice() -> None:
    allowed_paths = {
        ...
        "infra/docker/clawy-core-agent-python/openmagi_core_agent/harness/approval_receipts.py",
        "infra/docker/clawy-core-agent-python/openmagi_core_agent/harness/mission_runtime_boundary.py",
        "infra/docker/clawy-core-agent-python/openmagi_core_agent/memory/policy.py",
        "infra/docker/clawy-core-agent-python/openmagi_core_agent/memory/projection.py",
        "infra/docker/clawy-core-agent-python/openmagi_core_agent/memory/write_boundary.py",
        "infra/docker/clawy-core-agent-python/openmagi_core_agent/missions/events.py",
        "infra/docker/clawy-core-agent-python/openmagi_core_agent/plugins/native_catalog.py",
        "infra/docker/clawy-core-agent-python/openmagi_core_agent/self_improvement/eval_capture.py",
        "infra/docker/clawy-core-agent-python/openmagi_core_agent/self_improvement/promotion_gate.py",
        "infra/docker/clawy-core-agent-python/openmagi_core_agent/storage/__init__.py",
        "infra/docker/clawy-core-agent-python/openmagi_core_agent/storage/content_addressed.py",
        "infra/docker/clawy-core-agent-python/openmagi_core_agent/storage/durable_store.py",
        "infra/docker/clawy-core-agent-python/openmagi_core_agent/storage/memory_store.py",
        ...
        "infra/docker/clawy-core-agent-python/openmagi_core_agent/workspace/adoption_boundary.py",
        "infra/docker/clawy-core-agent-python/tests/fixtures/frontend_ts_compatibility/python_adk_run.json",
        "infra/docker/clawy-core-agent-python/tests/fixtures/parity/codex_class_work_agent_product_plane_matrix.json",
        "infra/docker/clawy-core-agent-python/tests/fixtures/parity/memory_self_improvement_mission_matrix.json",
        ...
        "infra/docker/clawy-core-agent-python/tests/test_durable_store_contract.py",
        "infra/docker/clawy-core-agent-python/tests/test_evidence_event_projection.py",
        "infra/docker/clawy-core-agent-python/tests/test_memory_contract.py",
        "infra/docker/clawy-core-agent-python/tests/test_memory_mission_final_review_hardening.py",
        "infra/docker/clawy-core-agent-python/tests/test_memory_mission_self_improvement_integration_contract.py",
        ...
        "infra/docker/clawy-core-agent-python/tests/test_mission_public_event_projection.py",
        "infra/docker/clawy-core-agent-python/tests/test_native_plugin_catalog.py",
        "infra/docker/clawy-core-agent-python/tests/test_plugin_audit_contract.py",
        "infra/docker/clawy-core-agent-python/tests/test_plugin_admin_routes.py",
        "infra/docker/clawy-core-agent-python/tests/test_plugin_tool_projection.py",
        "infra/docker/clawy-core-agent-python/tests/test_pr3_live_producer_parity_bridge.py",
        "infra/docker/clawy-core-agent-python/tests/test_public_event_parity_matrix.py",
        "infra/docker/clawy-core-agent-python/tests/test_reliability_materializer_integration.py",
        ...
        "infra/docker/clawy-core-agent-python/tests/test_self_improvement_eval_capture.py",
        "infra/docker/clawy-core-agent-python/tests/test_self_improvement_review_promotion_gate.py",
        "infra/docker/clawy-core-agent-python/tests/test_storage_content_addressed.py",
        "infra/docker/clawy-core-agent-python/tests/test_storage_turn_checkpoint.py",
    ...
    self_path = (
        "infra/docker/clawy-core-agent-python/tests/"
    ...
    independent_audit_paths = {
        ...
        "infra/docker/clawy-core-agent-python/tests/fixtures/parity/codex_class_work_agent_product_plane_matrix.json",
        "infra/docker/clawy-core-agent-python/tests/test_codex_class_work_agent_product_plane_matrix.py",
        "infra/docker/clawy-core-agent-python/tests/test_memory_self_improvement_mission_parity_matrix.py",
    }
    ...
    product_plane_pr2_paths = {
        "infra/docker/clawy-core-agent-python/openmagi_core_agent/ops/__init__.py",
        "infra/docker/clawy-core-agent-python/openmagi_core_agent/ops/contracts.py",
        "infra/docker/clawy-core-agent-python/openmagi_core_agent/ops/health.py",
        "infra/docker/clawy-core-agent-python/openmagi_core_agent/ops/metrics.py",
        "infra/docker/clawy-core-agent-python/openmagi_core_agent/ops/recorder.py",
        "infra/docker/clawy-core-agent-python/openmagi_core_agent/ops/runtime_events.py",
        "infra/docker/clawy-core-agent-python/openmagi_core_agent/ops/safety.py",
        "infra/docker/clawy-core-agent-python/openmagi_core_agent/ops/traces.py",
        "infra/docker/clawy-core-agent-python/openmagi_core_agent/transport/health.py",
        "infra/docker/clawy-core-agent-python/tests/fixtures/parity/codex_class_work_agent_product_plane_matrix.json",
        "infra/docker/clawy-core-agent-python/tests/test_codex_class_work_agent_product_plane_matrix.py",
        "infra/docker/clawy-core-agent-python/tests/test_memory_self_improvement_mission_parity_matrix.py",
        "infra/docker/clawy-core-agent-python/tests/test_ops_runtime_contracts.py",
    }
    if changed <= product_plane_pr2_paths:
        return
    product_plane_pr3_paths = {
        "infra/docker/clawy-core-agent-python/openmagi_core_agent/ops/job_queue.py",
        "infra/docker/clawy-core-agent-python/tests/fixtures/parity/codex_class_work_agent_product_plane_matrix.json",
        "infra/docker/clawy-core-agent-python/tests/test_memory_self_improvement_mission_parity_matrix.py",
        "infra/docker/clawy-core-agent-python/tests/test_ops_job_queue.py",
    }
    if changed <= product_plane_pr3_paths:
        return
    product_plane_pr4_paths = {
        "infra/docker/clawy-core-agent-python/openmagi_core_agent/sandbox/__init__.py",
        "infra/docker/clawy-core-agent-python/openmagi_core_agent/sandbox/browser.py",
        "infra/docker/clawy-core-agent-python/openmagi_core_agent/sandbox/child_workspace.py",
        "infra/docker/clawy-core-agent-python/openmagi_core_agent/sandbox/filesystem.py",
        "infra/docker/clawy-core-agent-python/openmagi_core_agent/sandbox/network.py",
        "infra/docker/clawy-core-agent-python/openmagi_core_agent/sandbox/policy.py",
        "infra/docker/clawy-core-agent-python/openmagi_core_agent/sandbox/process.py",
        "infra/docker/clawy-core-agent-python/tests/fixtures/parity/codex_class_work_agent_product_plane_matrix.json",
        "infra/docker/clawy-core-agent-python/tests/test_memory_self_improvement_mission_parity_matrix.py",
        "infra/docker/clawy-core-agent-python/tests/test_sandbox_policy.py",
    }
    if changed <= product_plane_pr4_paths:
        return
    product_plane_pr6_paths = {
        "infra/docker/clawy-core-agent-python/openmagi_core_agent/billing/__init__.py",
        "infra/docker/clawy-core-agent-python/openmagi_core_agent/billing/quota.py",
        "infra/docker/clawy-core-agent-python/openmagi_core_agent/billing/spend_guard.py",
        "infra/docker/clawy-core-agent-python/openmagi_core_agent/tenancy/__init__.py",
        "infra/docker/clawy-core-agent-python/openmagi_core_agent/tenancy/context.py",
        "infra/docker/clawy-core-agent-python/tests/fixtures/parity/codex_class_work_agent_product_plane_matrix.json",
        "infra/docker/clawy-core-agent-python/tests/test_memory_self_improvement_mission_parity_matrix.py",
        "infra/docker/clawy-core-agent-python/tests/test_tenancy_billing_quota_contracts.py",
    }
    if changed <= product_plane_pr6_paths:
        return
    product_plane_pr7_paths = {
        "infra/docker/clawy-core-agent-python/openmagi_core_agent/connectors/__init__.py",
        "infra/docker/clawy-core-agent-python/openmagi_core_agent/connectors/credential_lease.py",
        "infra/docker/clawy-core-agent-python/openmagi_core_agent/connectors/registry.py",
        "infra/docker/clawy-core-agent-python/tests/fixtures/parity/codex_class_work_agent_product_plane_matrix.json",
        "infra/docker/clawy-core-agent-python/tests/test_connector_credential_contracts.py",
        "infra/docker/clawy-core-agent-python/tests/test_memory_self_improvement_mission_parity_matrix.py",
    }
    if changed <= product_plane_pr7_paths:
        return
    product_plane_pr8_paths = {
        "infra/docker/clawy-core-agent-python/openmagi_core_agent/artifacts/__init__.py",
        "infra/docker/clawy-core-agent-python/openmagi_core_agent/artifacts/delivery_receipts.py",
        "infra/docker/clawy-core-agent-python/openmagi_core_agent/artifacts/file_delivery.py",
        "infra/docker/clawy-core-agent-python/openmagi_core_agent/artifacts/render_verification.py",
        "infra/docker/clawy-core-agent-python/tests/fixtures/parity/codex_class_work_agent_product_plane_matrix.json",
        "infra/docker/clawy-core-agent-python/tests/test_artifact_store_delivery_receipts.py",
        "infra/docker/clawy-core-agent-python/tests/test_memory_self_improvement_mission_parity_matrix.py",
    }
    if changed <= product_plane_pr8_paths:
        return
    product_plane_pr9_paths = {
        "infra/docker/clawy-core-agent-python/openmagi_core_agent/permissions/__init__.py",
        "infra/docker/clawy-core-agent-python/openmagi_core_agent/permissions/auto_control.py",
        "infra/docker/clawy-core-agent-python/tests/fixtures/parity/codex_class_work_agent_product_plane_matrix.json",
        "infra/docker/clawy-core-agent-python/tests/test_auto_permission_control_contract.py",
        "infra/docker/clawy-core-agent-python/tests/test_memory_self_improvement_mission_parity_matrix.py",
    }
    ...
    hermes_security_posture_pr10_paths = {
        ...
        "infra/docker/clawy-core-agent-python/openmagi_core_agent/config/models.py",
        "infra/docker/clawy-core-agent-python/tests/test_memory_self_improvement_mission_parity_matrix.py",
        "infra/docker/clawy-core-agent-python/tests/test_runtime_env_security_posture_config.py",
    }
    ...
    pregate8_continuity_pr2_paths = {
        ...
        "infra/docker/clawy-core-agent-python/openmagi_core_agent/runtime/openmagi_runtime.py",
        "infra/docker/clawy-core-agent-python/openmagi_core_agent/transport/health.py",
        "infra/docker/clawy-core-agent-python/tests/test_env.py",
    ...
    pregate8_continuity_pr3_paths = {
        ...
        "infra/docker/clawy-core-agent-python/openmagi_core_agent/transport/chat.py",
        "infra/docker/clawy-core-agent-python/tests/test_chat_route_context_continuity.py",
        "infra/docker/clawy-core-agent-python/tests/test_memory_self_improvement_mission_parity_matrix.py",
    }
    if changed <= pregate8_continuity_pr3_paths:
        return
    pregate8_continuity_pr4_paths = {
        "infra/docker/clawy-core-agent-python/openmagi_core_agent/gates/__init__.py",
        "infra/docker/clawy-core-agent-python/openmagi_core_agent/gates/pregate8_continuity_canary.py",
        "infra/docker/clawy-core-agent-python/tests/test_memory_self_improvement_mission_parity_matrix.py",
        "infra/docker/clawy-core-agent-python/tests/test_pregate8_continuity_canary.py",
    }
    ...
    gate2_readiness_foundation_paths = {
        ...
        "infra/docker/clawy-core-agent-python/openmagi_core_agent/shadow/__init__.py",
        "infra/docker/clawy-core-agent-python/openmagi_core_agent/shadow/gate2_recipe_profile_resolver.py",
    ...
    gate3_readiness_foundation_paths = gate2_readiness_foundation_paths | {
        "infra/docker/clawy-core-agent-python/openmagi_core_agent/gates/gate3_readiness.py",
        "infra/docker/clawy-core-agent-python/tests/test_gate3_readiness_foundations.py",
    }
    ...
    product_plane_pr10_paths = {
        "infra/docker/clawy-core-agent-python/openmagi_core_agent/evals/__init__.py",
        "infra/docker/clawy-core-agent-python/openmagi_core_agent/evals/release_gates.py",
        "infra/docker/clawy-core-agent-python/tests/fixtures/parity/codex_class_work_agent_product_plane_matrix.json",
        "infra/docker/clawy-core-agent-python/tests/test_memory_self_improvement_mission_parity_matrix.py",
        "infra/docker/clawy-core-agent-python/tests/test_product_release_gate_contracts.py",
    }
    if changed <= product_plane_pr10_paths:
        return
    product_plane_pr11_paths = {
        "infra/docker/clawy-core-agent-python/openmagi_core_agent/connectors/marketplace.py",
        "infra/docker/clawy-core-agent-python/tests/fixtures/parity/codex_class_work_agent_product_plane_matrix.json",
        "infra/docker/clawy-core-agent-python/tests/test_connector_marketplace_promotion_contract.py",
        "infra/docker/clawy-core-agent-python/tests/test_memory_self_improvement_mission_parity_matrix.py",
    }
    if changed <= product_plane_pr11_paths:
        return
    product_plane_pr12_paths = {
        "infra/docker/clawy-core-agent-python/openmagi_core_agent/security/__init__.py",
        "infra/docker/clawy-core-agent-python/openmagi_core_agent/security/compliance.py",
        "infra/docker/clawy-core-agent-python/openmagi_core_agent/transport/product_admin.py",
        "infra/docker/clawy-core-agent-python/tests/fixtures/parity/codex_class_work_agent_product_plane_matrix.json",
        "infra/docker/clawy-core-agent-python/tests/test_memory_self_improvement_mission_parity_matrix.py",
        "infra/docker/clawy-core-agent-python/tests/test_product_admin_api_contracts.py",
        "infra/docker/clawy-core-agent-python/tests/test_security_compliance_contracts.py",
    }
    ...
    product_plane_pr13_paths = {
        ...
        "infra/docker/clawy-core-agent-python/README.md",
        "infra/docker/clawy-core-agent-python/tests/fixtures/parity/codex_class_work_agent_product_plane_matrix.json",
        "infra/docker/clawy-core-agent-python/tests/test_codex_product_plane_integration_contract.py",
        "infra/docker/clawy-core-agent-python/tests/test_memory_self_improvement_mission_parity_matrix.py",
    }
    ...
    live_work_console_pr2_paths = {
        ...
        "infra/docker/clawy-core-agent-python/openmagi_core_agent/transport/sse.py",
        "infra/docker/clawy-core-agent-python/tests/fixtures/public_event_parity/matrix.json",
        "infra/docker/clawy-core-agent-python/tests/fixtures/sse/simple_text.txt",
        "infra/docker/clawy-core-agent-python/tests/fixtures/sse/tool_call.txt",
        "infra/docker/clawy-core-agent-python/tests/test_adk_runner_lifecycle_events.py",
        "infra/docker/clawy-core-agent-python/tests/test_event_bridge.py",
        "infra/docker/clawy-core-agent-python/tests/test_memory_self_improvement_mission_parity_matrix.py",
        "infra/docker/clawy-core-agent-python/tests/test_priority_a_runner_session_boundary.py",
        "infra/docker/clawy-core-agent-python/tests/test_sse_writer.py",
    }
    ...
    frontend_ts_pr8_canary_paths = {
        ...
        "infra/docker/clawy-core-agent-python/openmagi_core_agent/transport/sse.py",
        "infra/docker/clawy-core-agent-python/tests/fixtures/frontend_ts_compatibility/python_adk_run.json",
        "infra/docker/clawy-core-agent-python/tests/test_frontend_ts_compatibility_fixture.py",
        "infra/docker/clawy-core-agent-python/tests/test_memory_self_improvement_mission_parity_matrix.py",
    ...
    opencode_final_review_security_fix_paths = {
        "infra/docker/clawy-core-agent-python/openmagi_core_agent/coding/final_projection.py",
        "infra/docker/clawy-core-agent-python/openmagi_core_agent/research/final_projection_gate.py",
        "infra/docker/clawy-core-agent-python/openmagi_core_agent/storage/session_store.py",
        "infra/docker/clawy-core-agent-python/tests/test_coding_final_projection.py",
        "infra/docker/clawy-core-agent-python/tests/test_memory_self_improvement_mission_parity_matrix.py",
        "infra/docker/clawy-core-agent-python/tests/test_research_final_projection_gate.py",
        "infra/docker/clawy-core-agent-python/tests/test_session_service_persistence.py",
        "infra/docker/clawy-core-agent-python/tests/test_session_sqlite_store.py",
    }
