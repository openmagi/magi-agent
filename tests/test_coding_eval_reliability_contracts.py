...
def test_pr8_matrix_row_points_to_gap_fixture_and_stays_default_off() -> None:
    ...
    assert "magi_agent/self_improvement/eval_capture.py" not in row["coveredByFiles"]
    assert "tests/test_self_improvement_eval_capture.py" not in row["coveredByTests"]
