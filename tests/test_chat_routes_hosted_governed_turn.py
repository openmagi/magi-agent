...
def test_flag_off_uses_gate5b4c3_boundary(monkeypatch, tmp_path: Any) -> None:
    ...
    monkeypatch.setattr(chat_routes_module, "run_gate5b4c3_live_runner_boundary_async", fake_boundary)
    monkeypatch.setattr(chat_routes_module, "run_governed_turn", fake_governed_turn)
    monkeypatch.setattr(chat_routes_module, "collect_engine_to_boundary_result", fake_collect)
...
def test_flag_on_uses_governed_turn(monkeypatch, tmp_path: Any) -> None:
    ...
    monkeypatch.setattr(chat_routes_module, "run_gate5b4c3_live_runner_boundary_async", fail_boundary)
    monkeypatch.setattr(chat_routes_module, "run_governed_turn", fake_governed_turn)
    monkeypatch.setattr(chat_routes_module, "collect_engine_to_boundary_result", fake_collect)
