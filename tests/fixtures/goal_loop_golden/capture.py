"""Golden capture/regen for the goal-loop decision oracle. --write guarded.

Usage:
    python -m tests.fixtures.goal_loop_golden.capture --write
    python -m tests.fixtures.goal_loop_golden.capture            # dry-run/diff
"""
...
from tests.fixtures.goal_loop_golden import scenarios

GOLDEN_DIR = Path(__file__).parent / "golden"

SCENARIOS: dict[str, Callable[[], list[dict[str, Any]]]] = {
    "decision_matrix": scenarios.run_decision_matrix_scenario,
}
