...
def test_flag_on_valid_ext_code_recipe_registered(
    ...
    assert manifest is not None, (
        "code recipe not registered. DIAGNOSTIC: "
        f"flag_on={recipe_as_code_enabled()}, "
        f"impl_imported={'code_recipe_ok.impl' in _sys.modules}, "
        f"registered_refs={report.registered}, "
        f"all_recipe_refs={registries.recipes.list_refs()}"
    )
