...
from openmagi_core_agent.config.models import PythonGate4ReadinessConfig
...
_SURFACE_MODULES = {
    "gate4_local_shadow_consumer": "openmagi_core_agent.shadow.gate4_consumer",
    "gate4c0_shadow_config": "openmagi_core_agent.shadow.gate4c0_shadow_config",
    "gate4c1_dry_run_boundary": "openmagi_core_agent.shadow.gate4c1_dry_run_boundary",
    "gate4c1_runner_invoker_contract": (
        "openmagi_core_agent.shadow.gate4c1_runner_shadow_invoker"
    ),
    "gate4c2_shadow_comparison_report": (
        "openmagi_core_agent.shadow.gate4c2_shadow_comparison_report"
    ),
    "gate4d_local_shadow_diagnostics": (
        "openmagi_core_agent.shadow.gate4d_local_shadow_diagnostics"
    ),
}
