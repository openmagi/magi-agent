...
from openmagi_core_agent.config.models import PythonGate7ReadinessConfig
...
_SURFACE_MODULES = {
    "local_child_runner_boundary": "openmagi_core_agent.runtime.child_runner_boundary",
    "child_runtime_envelope": "openmagi_core_agent.evidence.child_runtime_envelope",
    "workspace_adoption_preflight_contract": (
        "openmagi_core_agent.shadow.workspace_adoption_preflight_contract"
    ),
    "workspace_adoption_boundary": "openmagi_core_agent.workspace.adoption_boundary",
    "coding_subagent_recipe_boundary": "openmagi_core_agent.recipes.coding_subagents",
}
