...
---------------------
``import openmagi_core_agent.cli.wiring`` must succeed without importing
...
from openmagi_core_agent.cli.permissions import PermissionMode, RulesPermissionGate
...
def build_tui_app(
    *,
    ...
    # ------------------------------------------------------------------ #
    from openmagi_core_agent.cli.tui.app import MagiTuiApp  # noqa: PLC0415
    from openmagi_core_agent.cli.tui.tool_render import build_tool_renderers  # noqa: PLC0415
