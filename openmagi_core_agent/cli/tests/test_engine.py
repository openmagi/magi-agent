...
from openmagi_core_agent.cli.contracts import EngineResult, RuntimeEvent, Terminal
from openmagi_core_agent.cli.engine import MagiEngineDriver
from openmagi_core_agent.cli.headless import drain, run_headless
...
def test_sanitizer_drops_thinking_events(monkeypatch: pytest.MonkeyPatch) -> None:
    ...
    import openmagi_core_agent.cli.engine as engine_mod
...
def test_engine_import_clean_in_fresh_interpreter() -> None:
    ...
    code = (
        "import openmagi_core_agent.cli.engine, sys;"
