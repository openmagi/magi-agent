...
from openmagi_core_agent.cli.headless import StubEngineDriver
...
def _make_app():
    ...
    from openmagi_core_agent.cli.app import app
    return app
...
class TestBuildTuiApp:
    def test_returns_magi_tui_app(self) -> None:
        ...
        from openmagi_core_agent.cli.wiring import build_tui_app
    ...
    def test_runtime_runner_receives_composio_toolsets_without_explicit_runner(
        ...
        fake_app_module = ModuleType("openmagi_core_agent.cli.tui.app")
        fake_app_module.MagiTuiApp = FakeMagiTuiApp
        fake_tool_render_module = ModuleType("openmagi_core_agent.cli.tui.tool_render")
        ...
        with patch(
            "openmagi_core_agent.cli.wiring.build_composio_toolset_bundle",
...
class TestModeBranchNonInteractive:
    def test_non_interactive_stdin_calls_headless(self, monkeypatch: pytest.MonkeyPatch, tmp_path) -> None:
        ...
        with patch("openmagi_core_agent.cli.app.run_headless", fake_headless), \
             patch("openmagi_core_agent.cli.app.build_tui_app", fake_build_tui):
...
class TestModeBranchInteractive:
    def test_interactive_no_prompt_calls_tui(self, monkeypatch: pytest.MonkeyPatch, tmp_path) -> None:
        ...
        import openmagi_core_agent.cli.app as app_module
...
def test_build_headless_runtime_attaches_composio_to_injected_runner(monkeypatch, tmp_path) -> None:
    ...
    with patch("openmagi_core_agent.cli.wiring.build_composio_toolset_bundle", return_value=FakeBundle()):
