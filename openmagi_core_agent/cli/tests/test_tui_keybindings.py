...
from openmagi_core_agent.cli.keybindings import (
    Context,
    Keystroke,
    ParsedBinding,
    ResultKind,
...
from openmagi_core_agent.cli.keybindings.defaults import default_bindings
...
def test_keybindings_package_import_clean_in_fresh_interpreter() -> None:
    ...
    code = (
        "import openmagi_core_agent.cli.keybindings as kb;"
        "import openmagi_core_agent.cli.keybindings.schema;"
        "import openmagi_core_agent.cli.keybindings.resolver;"
        "import openmagi_core_agent.cli.keybindings.defaults;"
        "import openmagi_core_agent.cli.keybindings.loader;"
        "import sys;"
