...
from openmagi_core_agent.cli.contracts import RenderNode, ToolRenderer
from openmagi_core_agent.cli.tui import tool_render
...
def test_register_default_renderers_into_existing_registry() -> None:
    from openmagi_core_agent.cli.contracts import ToolRendererRegistry
