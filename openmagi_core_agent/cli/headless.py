...
from openmagi_core_agent.cli.protocol import (
    AssistantFrame,
    ResultFrame,
    StreamEvent,
    SystemInit,
...
# openmagi_core_agent.transport.sse._sanitize_agent_event internally to redact
...
async def _dispatch_headless_command(
    ...
    *,
    ...
    from openmagi_core_agent.cli.commands import dispatch
...
def _route_inbound_line(
    ...
    *,
    ...
    from openmagi_core_agent.cli.protocol import ControlCancel, ControlResponse
...
async def run_headless(
    ...
    *,
    ...
    if (
        ...
        from openmagi_core_agent.cli.permissions import HeadlessSink
