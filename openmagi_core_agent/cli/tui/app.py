...
``TextualSink``
    A :class:`~openmagi_core_agent.cli.contracts.PromptSink` whose ``ask`` pushes
...
from openmagi_core_agent.cli.keybindings.loader import load_keybindings
...
from openmagi_core_agent.cli.keybindings.schema import Action, Context, Keystroke, ParsedBinding
from openmagi_core_agent.cli.tui.autocomplete import (
    AutocompleteRouter,
    Completion,
    CompletionProvider,
)
from openmagi_core_agent.cli.tui.input import PromptInput, Submission
