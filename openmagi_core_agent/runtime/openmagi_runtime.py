...
from openmagi_core_agent.config.models import RuntimeConfig
from openmagi_core_agent.harness.profiles import RuntimeProfile, build_default_profile

if TYPE_CHECKING:
    from openmagi_core_agent.plugins.manager import ResolvedPluginState
...
def _build_default_plugin_state() -> ResolvedPluginState:
    from openmagi_core_agent.plugins.manager import resolve_plugin_state
