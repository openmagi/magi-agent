...
_KNOWN_TOKEN_LIMITS = {
    ...
    "gpt-5.5": 750_000,
    "clawy-smart-router/auto": 750_000,
...
def build_system_prompt_blocks(
    *,
    ...
    :class:`~openmagi_core_agent.prompt.injection.CacheControlInjector`.
    ...
    from openmagi_core_agent.prompt.splitter import split_system_prompt
    from openmagi_core_agent.prompt.injection import CacheControlInjector
...
def _render_identity_system(
    ...
    *,
    ...
    if model_aware_prompts_enabled and model and parts:
        from openmagi_core_agent.prompt.provider_adapter import adapt_identity_sections
