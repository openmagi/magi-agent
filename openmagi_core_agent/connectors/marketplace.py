...
from openmagi_core_agent.connectors.registry import ConnectorManifest
...
from openmagi_core_agent.plugins.manifest import PermissionClass, PluginManifest
from openmagi_core_agent.plugins.sandbox_policy import SandboxMode, evaluate_plugin_sandbox
