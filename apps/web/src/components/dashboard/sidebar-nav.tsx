...
export function SidebarNav({ onNavigate, className }: SidebarNavProps) {
  ...
  const botNavItems = [
    ...
    { href: `${botPrefix}/integrations`, label: "Integrations", icon: Plug },
    { href: `${botPrefix}/credentials`, label: "Credentials", icon: KeyRound },
    { href: `${botPrefix}/usage`, label: t.dashboard.usage, icon: Gauge },
    { href: `${botPrefix}/observability`, label: "Observability", icon: Activity },
    { href: `${botPrefix}/work-queue`, label: "Work Queue", icon: ListChecks },
