...
describe("message copy text", () => {
  it("strips hidden KB context metadata from full-message copies", () => {
    const text = buildMessageCopyText({
      content:
        "[KB_CONTEXT: 56fdc3c1-7da2-47c4-a87a-83d35beced19=magi_gemini_v0_3_agent_tester_prompt.md]\n" +
    ...
    expect(text).not.toContain("magi_gemini_v0_3_agent_tester_prompt.md");
  });
