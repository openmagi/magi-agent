...
describe("stripResearchEvidenceMarker", () => {
  it("removes trailing research evidence HTML comment", () => {
    const content = "Hello world\n\n<!-- magi:research-evidence:v1:eyJpbnNwZWN0ZWRTb3VyY2VzIjpbXX0 -->";
