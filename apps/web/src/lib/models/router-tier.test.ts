...
describe("router-tier model picker helpers", () => {
  it("maps persisted standard and premium router rows to compact picker modes", () => {
    expect(getRouterPickerMode("magi_smart_routing", "standard")).toBe("standard_router");
    expect(getRouterPickerMode("magi_smart_routing", "big_dic")).toBe("premium_router");
  ...
  it("uses product-facing router labels", () => {
    expect(getRouterDisplayName("magi_smart_routing", "standard")).toBe("Standard Router");
    expect(getRouterDisplayName("magi_smart_routing", "big_dic")).toBe("Premium Router");
