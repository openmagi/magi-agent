...
export function getRouterPickerMode(
  ...
  if (modelSelection === "clawy_smart_routing" && routerType === "big_dic") {
    return "premium_router";
  }
  if (modelSelection === "clawy_smart_routing" && (!routerType || routerType === "standard")) {
...
export function applyRouterPickerMode(
  ...
  if (mode === "standard_router") {
    return { modelSelection: "clawy_smart_routing", routerType: "standard" };
  }
  if (mode === "premium_router") {
    return { modelSelection: "clawy_smart_routing", routerType: "big_dic" };
  }
  return {
