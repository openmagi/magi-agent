...
function SnapshotList({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { id, className: "snapshot-list", children: items.map((item, index) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "button",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "snapshot-title", children: asString(item.title) || asString(item.name) || asString(item.sessionKey) || asString(item.taskId) || asString(item.cronId) || asString(item.path) || `item ${index + 1}` }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "snapshot-meta", children: asString(item.status) || asString(item.kind) || asString(item.collection) || asString(item.permission) || preview(item.meta, 60) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "snapshot-detail", children: asString(item.detail) || asString(item.promptPreview) || asString(item.resultPreview) || asString(item.path) || preview(item.contentPreview || item.inputPreview || item.outputPreview, 120) })
      ]
    },
    `${asString(item.id) || asString(item.taskId) || asString(item.path) || index}`
  )) });
}
...
function OpenMagiLogo() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "openmagi-logo", "aria-label": "Open Magi", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "logo-mark", children: "M" }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { children: [
      "Open ",
      /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { children: "Magi" })
    ] })
  ] });
}
function DashboardSidebar({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("aside", { className: "dashboard-sidebar", "aria-label": "Dashboard navigation", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { className: "bot-switcher", type: "button", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "Magi_Local" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Icon, { name: "chevron" })
    ] }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "sidebar-footer", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: runtimeStatus })
    ] })
  ] });
}
...
function RuntimeMetrics({ runtime, eventCount }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "metric-grid", children: rows.map(([label, value]) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
...
function WorkDock({
  ...
  const activeTools = toolRows.length > 0 ? toolRows : [
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("aside", { className: "work-dock", "aria-label": "Work", children: [
    ...
    activeDock === "work" ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "dock-panel", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "work-card live", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "work-card-title", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "NOW" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(Pill, { tone: "purple", children: "LIVE" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "work-step running", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", {}),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { children: "Running" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "Runtime is ready for a local session." })
          ] })
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "work-card helpers-card", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "work-card-title", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "HELPERS" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(Pill, { tone: "green", children: [
            helperRows.length,
            " AGENTS"
          ] })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "helper-grid", children: helperRows.map((helper) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "helper-chip", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: `helper-dot ${helper.tone}` }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("strong", { children: [
            helper.name,
            " ",
            /* @__PURE__ */ jsxRuntimeExports.jsx("em", { children: helper.role })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "helper-bar", children: [
            "iteration ",
            helper.iteration
          ] })
        ] }, helper.name)) })
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "work-card", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "work-card-title", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "CURRENT STEPS" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(Pill, { children: activeTools.length })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { id: "tasks-list", className: "current-step-list", children: activeTools.map((tool, index) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "current-step-row", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "green-dot" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { children: asString(tool.title) || asString(tool.name) || asString(tool.taskId) || "Working in workspace" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: asString(tool.detail) || asString(tool.promptPreview) || asString(tool.status, "Status: running") })
          ] })
        ] }, `${asString(tool.taskId) || asString(tool.title) || index}`)) })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "work-card", children: [
...
function ChatView({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "cloud-chat-shell", "data-cloud-chat-shell": "true", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("main", { className: "chat-main", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "current-run-card", "aria-label": "Current run", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "run-grid", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { children: isStreaming ? "Running" : "Ready" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "CURRENT WORK" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { children: isStreaming ? "Working on your request" : "Waiting for input" })
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "form",
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "composer-mode-row", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("button", { type: "button", className: "mode-active", children: "Queue after run" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("button", { type: "button", children: "Steer current run" })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "textarea",
              {
...
function Overview({ runtime, eventCount }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("main", { className: "dashboard-content", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "page-title", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "Manage your local agent and monitor runtime performance." })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "cloud-card bot-card", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bot-card-header", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bot-name", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "green-dot" }),
          " ",
          /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { children: "Magi_Local" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Pill, { tone: "green", children: "Active" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bot-facts", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "Runtime" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { children: "Self-hosted" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { children: "./workspace" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "settings-tabs", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("button", { type: "button", children: "Settings" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("button", { type: "button", children: "Usage" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("button", { type: "button", children: "Runtime proof" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(RuntimeMetrics, { runtime, eventCount })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "cloud-card", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "card-heading", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { children: "Integrations" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "Connect local providers and workspace services to your runtime." })
      ] }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "integration-row", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "integration-icon", children: "O" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { children: "OpenAI-compatible" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "Ollama, LM Studio, vLLM, llama.cpp, LiteLLM" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Pill, { tone: "green", children: "Local" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "integration-row", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "integration-icon", children: "K" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { children: "Workspace Knowledge" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "Markdown, text, CSV, JSON, YAML, HTML" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Pill, { tone: "green", children: "Connected" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "integration-row", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "integration-icon", children: "C" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { children: "Cron workflows" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "Scheduled runs with delivery safety" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Pill, { tone: "purple", children: "Runtime" })
      ] })
    ] })
  ] });
}
function Settings({
  ...
  const updateLlm = (patch) => setConfig({ ...config, llm: { ...llm, ...patch } });
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("main", { className: "dashboard-content", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "page-title", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { children: "Settings" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "Local runtime connection, model routing, and agent safeguards." })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "cloud-card settings-card", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("form", { id: "connection-form", onSubmit: (event) => {
      event.preventDefault();
      onSaveConnection();
    }, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "settings-row-title", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { children: "Local Runtime" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Pill, { tone: runtimeStatus === "active" ? "green" : "purple", children: runtimeStatus })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Field, { label: "Agent URL", children: /* @__PURE__ */ jsxRuntimeExports.jsx("input", { id: "agent-url", value: agentUrl, onChange: (event) => setAgentUrl(event.target.value) }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Field, { label: "Server token", children: /* @__PURE__ */ jsxRuntimeExports.jsx("input", { id: "server-token", type: "password", value: token, onChange: (event) => setToken(event.target.value) }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Field, { label: "Session key", children: /* @__PURE__ */ jsxRuntimeExports.jsx("input", { id: "session-key", value: sessionKey, onChange: (event) => setSessionKey(event.target.value) }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("label", { className: "check-row", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("input", { id: "plan-mode", type: "checkbox", checked: planMode, onChange: (event) => setPlanMode(event.target.checked) }),
        "Plan mode"
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "row-actions", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("button", { type: "submit", children: "Save Settings" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("button", { id: "health-button", type: "button", onClick: onCheckRuntime, children: "Check Runtime" }),
        installAvailable && /* @__PURE__ */ jsxRuntimeExports.jsx("button", { id: "install-button", type: "button", onClick: onInstall, children: "Install App" })
      ] })
    ] }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "cloud-card settings-card", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("form", { id: "runtime-config-form", onSubmit: (event) => {
      event.preventDefault();
      onSaveConfig();
    }, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Field, { label: "Model", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("select", { id: "config-provider", value: llm.provider ?? "openai-compatible", onChange: (event) => updateLlm({ provider: event.target.value }), children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "openai-compatible", children: "Custom" }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(Field, { label: "Custom model", children: /* @__PURE__ */ jsxRuntimeExports.jsx("input", { id: "config-model", value: llm.model ?? "", onChange: (event) => updateLlm({ model: event.target.value }), placeholder: "llama3.1" }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Field, { label: "Base URL", children: /* @__PURE__ */ jsxRuntimeExports.jsx("input", { id: "config-base-url", value: llm.baseUrl ?? "", onChange: (event) => updateLlm({ baseUrl: event.target.value }), placeholder: "http://host.docker.internal:11434/v1" }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "two-col", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Field, { label: "API key env var", children: /* @__PURE__ */ jsxRuntimeExports.jsx("input", { id: "config-api-key-env", value: llm.apiKeyEnvVar ?? "", onChange: (event) => updateLlm({ apiKeyEnvVar: event.target.value }) }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Field, { label: "Server token env var", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
          "input",
          {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(Field, { label: "Workspace", children: /* @__PURE__ */ jsxRuntimeExports.jsx("input", { id: "config-workspace", value: config.workspace ?? "./workspace", onChange: (event) => setConfig({ ...config, workspace: event.target.value }) }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "two-col", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Field, { label: "Context window", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
          "input",
          {
            id: "config-context-window",
            type: "number",
            value: capabilities.contextWindow ?? "",
            onChange: (event) => updateLlm({ capabilities: { ...capabilities, contextWindow: Number(event.target.value) || void 0 } })
          }
        ) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Field, { label: "Max output tokens", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
          "input",
          {
            id: "config-max-output",
            type: "number",
            value: capabilities.maxOutputTokens ?? "",
            onChange: (event) => updateLlm({ capabilities: { ...capabilities, maxOutputTokens: Number(event.target.value) || void 0 } })
          }
        ) })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "row-actions", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("button", { type: "submit", children: "Save Config" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("button", { id: "config-reload-button", type: "button", onClick: onReloadConfig, children: "Reload" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { id: "config-restart-status", className: "muted-line", children: configStatus })
    ] }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "cloud-card settings-card", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { children: "Agent Safeguards" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "muted-line", children: "Build safeguards that tell the agent what it must verify, deliver, or ask before finishing work." }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("form", { id: "harness-rule-form", onSubmit: (event) => {
        event.preventDefault();
        onSaveHarnessRule();
      }, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Field, { label: "Rule file", children: /* @__PURE__ */ jsxRuntimeExports.jsx("input", { id: "harness-rule-name", value: harnessName, onChange: (event) => setHarnessName(event.target.value), placeholder: "file-delivery.md" }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Field, { label: "Markdown rule", children: /* @__PURE__ */ jsxRuntimeExports.jsx("textarea", { id: "harness-rule-content", rows: 7, value: harnessContent, onChange: (event) => setHarnessContent(event.target.value) }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("button", { type: "submit", children: "Save Rule" })
      ] })
    ] })
  ] });
}
function KnowledgePage({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("main", { className: "dashboard-content", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "page-title", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { children: "Knowledge Base" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { children: [
        "Local KB backed by files under ",
        /* @__PURE__ */ jsxRuntimeExports.jsx("code", { children: "workspace/knowledge" }),
        "."
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "cloud-card", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("form", { id: "knowledge-search-page-form", onSubmit: (event) => {
        event.preventDefault();
        onSearchKnowledge();
      }, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Field, { label: "Search documents", children: /* @__PURE__ */ jsxRuntimeExports.jsx("input", { value: knowledgeQuery, onChange: (event) => setKnowledgeQuery(event.target.value), placeholder: "reusable runtime context" }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "row-actions", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("button", { type: "submit", children: "Search" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("button", { type: "button", onClick: onLoadKnowledge, children: "List documents" })
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(SnapshotList, { items: knowledgeItems, empty: "No local KB documents" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "cloud-card", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { children: "Write a KB document" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("form", { onSubmit: (event) => {
        event.preventDefault();
        onSaveKnowledge();
      }, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Field, { label: "Path", children: /* @__PURE__ */ jsxRuntimeExports.jsx("input", { value: knowledgePath, onChange: (event) => setKnowledgePath(event.target.value), placeholder: "reports/brief.md" }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Field, { label: "Markdown", children: /* @__PURE__ */ jsxRuntimeExports.jsx("textarea", { rows: 10, value: knowledgeContent, onChange: (event) => setKnowledgeContent(event.target.value) }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("button", { type: "submit", children: "Save KB document" })
      ] })
    ] })
  ] });
}
function UtilityPage({ title, description, children }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("main", { className: "dashboard-content", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "page-title", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { children: title }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: description })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "cloud-card", children })
  ] });
}
function App() {
  ...
  const [sessionKey, setSessionKey] = reactExports.useState(() => getStored(storage.sessionKey, defaultSessionKey()));
  const [modelOverride, setModelOverride] = reactExports.useState(() => getStored(storage.modelOverride, "auto"));
  const [planMode, setPlanMode] = reactExports.useState(false);
  const [runtimeStatus, setRuntimeStatus] = reactExports.useState("active");
  ...
  const [deferredInstallPrompt, setDeferredInstallPrompt] = reactExports.useState(null);
  const [config, setConfig] = reactExports.useState({});
  const [configStatus, setConfigStatus] = reactExports.useState("");
  const [knowledgeQuery, setKnowledgeQuery] = reactExports.useState("");
  const [knowledgePath, setKnowledgePath] = reactExports.useState("notes/local.md");
  const [knowledgeContent, setKnowledgeContent] = reactExports.useState("# Local note\n\n");
  const [knowledgeItems, setKnowledgeItems] = reactExports.useState([]);
  ...
  const [cronPrompt, setCronPrompt] = reactExports.useState("");
  const [harnessName, setHarnessName] = reactExports.useState("file-delivery.md");
  const [harnessContent, setHarnessContent] = reactExports.useState("---\ntrigger: beforeCommit\naction:\n  type: require_tool\n  toolName: FileDeliver\n---\nDeliver generated files before claiming completion.\n");
  const addEvent = reactExports.useCallback((type, payload = {}) => {
  ...
  const getJson = reactExports.useCallback(async (path) => {
  ...
  const sendJson = reactExports.useCallback(async (path, method, body) => {
  ...
  const saveConnection = reactExports.useCallback(() => {
  ...
  const loadAppConfig = reactExports.useCallback(async () => {
    const payload = await getJson("/v1/app/config");
    setConfig(payload.config ?? {});
    addEvent("config_loaded", { exists: payload.exists === true });
  }, [addEvent, getJson]);
  const loadTranscript = reactExports.useCallback(async () => {
  ...
  const loadEvidence = reactExports.useCallback(async () => {
  ...
  const loadKnowledge = reactExports.useCallback(async () => {
  ...
  const searchKnowledge = reactExports.useCallback(async () => {
  ...
  const saveKnowledge = reactExports.useCallback(async () => {
  ...
  const saveCron = reactExports.useCallback(async () => {
  ...
  const reloadSkills = reactExports.useCallback(async () => {
  ...
  const saveAppConfig = reactExports.useCallback(async () => {
    const llm = config.llm ?? {};
    const server = config.server ?? {};
  ...
  const reloadRuntimeConfig = reactExports.useCallback(async () => {
  ...
  const saveHarnessRule = reactExports.useCallback(async () => {
  ...
  const checkRuntime = reactExports.useCallback(async () => {
  ...
  const appendAssistantText = reactExports.useCallback((text) => {
    setMessages((current) => {
  ...
  const finishAssistantMessage = reactExports.useCallback(() => {
    setMessages((current) => current.map((message) => message.streaming ? { ...message, streaming: false } : message));
  }, []);
  const handleSseEvent = reactExports.useCallback((eventName, rawData) => {
    if (rawData === "[DONE]") {
    ...
    const delta = choices[0] && typeof choices[0] === "object" ? choices[0].delta?.content : void 0;
    if (typeof delta === "string") appendAssistantText(delta);
    if (choices[0] && typeof choices[0] === "object" && choices[0].finish_reason) finishAssistantMessage();
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "dashboard-shell", "data-dashboard-shell": "true", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(DashboardSidebar, { active, setActive, runtimeStatus }),
    active === "overview" && /* @__PURE__ */ jsxRuntimeExports.jsx(Overview, { runtime, eventCount: events.length }),
    active === "settings" && /* @__PURE__ */ jsxRuntimeExports.jsx(
      Settings,
      {
        agentUrl,
        setAgentUrl,
    ...
    active === "knowledge" && /* @__PURE__ */ jsxRuntimeExports.jsx(KnowledgePage, { ...knowledgeProps }),
    active === "usage" && /* @__PURE__ */ jsxRuntimeExports.jsxs(UtilityPage, { title: "Usage", description: "Local runtime usage counters and recent proof events.", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(RuntimeMetrics, { runtime, eventCount: events.length }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(SnapshotList, { id: "transcript-list", items: transcriptItems, empty: "No transcript entries" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(SnapshotList, { id: "evidence-list", items: evidenceItems, empty: "No runtime proof evidence" })
    ] }),
    active === "skills" && /* @__PURE__ */ jsxRuntimeExports.jsxs(UtilityPage, { title: "Skills", description: "Reload and inspect workspace SKILL.md capabilities.", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("button", { id: "reload-skills-button", type: "button", onClick: () => void reloadSkills(), children: "Reload Skills" }),
