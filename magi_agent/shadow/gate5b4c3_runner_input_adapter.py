    ...
    *,
    ...
    if request.recipe_profile.tools_policy == "selected_full_toolhost":
        base = (
            ...
            "are attached. Every turn must end with a normal text answer for the user; "
            ...
            "running; either complete the requested work in this turn or clearly state "
            "the concrete blocker. Do not claim broad production workspace "
            "authority. Keep all workspace writes inside the selected workspace root. "
            "Do not write memory, send channel messages, use browser or external "
            "integrations, execute child agents, run mission runtime, use evidence "
