...
| projection.py | Pure mapping kernel: work_queue substrate -> hosted "mission" shape. | models | missions/projector.py, transport/app_api.py |
...
| scheduled_work.py | — | _common, context, env, models, policy, projector, result, store | — |
