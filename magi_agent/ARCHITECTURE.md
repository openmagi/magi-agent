...
| __main__.py | — | main | — |
| app.py | — | active_sessions, app_api, board_api, bootstrap, chat, composio_broker, config, control_requests, credentials, customize, daemon, debug_trace, health, integrations, learning_dashboard, observability, openmagi_runtime, packs_dashboard, plugins, streaming_chat_route, tools, web_dashboard | (root)/main.py |
...
| lifecycle_llm_call_control.py | LifecycleLlmCallAuditControl — PR-F-LIFE2 per-LLM-call audit fan-out. | control_plane, lifecycle_audit, wiring | adk_bridge/control_plane.py, adk_bridge/lifecycle_session_control.py, artifacts/file_delivery.py, engine/driver.py, missions/work_queue/driver.py |
...
| headless.py | Headless entrypoint for the Magi CLI (PR-A1). | citation_render, commands, contracts, durable_checkpoint_emitter, durable_checkpoint_store, durable_side_effects, engine, env, event_projection, flags, governed_turn, ledger_store, live_audit, manual_compaction_context, memory_mode_context, memory_turn_hook, ndjson, permissions, protocol, redaction, session_extract_runtime, session_log, streaming_chat, turn_context | cli/app.py, cli/tests/test_a4_cli_skill_args_name_tolerance.py, cli/tests/test_app.py, cli/tests/test_contracts_a3.py, cli/tests/test_e2e_parity.py, cli/tests/test_engine.py, cli/tests/test_engine_gate.py, cli/tests/test_engine_output_continuation.py, cli/tests/test_engine_recovery.py, cli/tests/test_engine_usage.py, cli/tests/test_headless.py, cli/tests/test_headless_approval.py, cli/tests/test_headless_projection.py, cli/tests/test_permissions.py, cli/tui/input.py, transport/hosted_engine_result.py |
...
| discovery.py | Command discovery + precedence merge for the Magi CLI (Stream D, PR-D2/D3). | builtins, bundled, contracts, control, registry, session_history, skill_commands | cli/commands/__init__.py, cli/commands/skill_commands.py, cli/tests/test_a4_cli_skill_args_name_tolerance.py, cli/tests/test_commands.py, cli/tests/test_headless_projection.py, cli/tests/test_slash_p1_sources.py, cli/tests/test_slash_p2_control.py, cli/tests/test_slash_p2_mcp.py, cli/tests/test_slash_p3_seams.py |
...
| skill_commands.py | Skill → command bridge for the Magi CLI (Stream D, PR-D3 / P1.3). | contracts, discovery | cli/commands/discovery.py, cli/tests/test_a4_cli_skill_args_name_tolerance.py, cli/tests/test_slash_p1_sources.py |
...
| test_a4_cli_skill_args_name_tolerance.py | Tests for Unit A4: CLI skill args drop fix (C3) + custom- name tolerance (C11). | contracts, discovery, headless, input, skill_commands | — |
...
| test_app.py | Tests for cli/app.py (Typer entrypoint) and cli/wiring.py (PR-F1). | __main__, app, cli, contracts, engine, env, headless, main, permissions, real_runner, serve_token, session_log, wiring | — |
...
| input.py | Prompt input widget + submission routing for the Magi TUI (PR-E2 / PR1.1). | autocomplete, contracts, headless, history | cli/tests/test_a4_cli_skill_args_name_tolerance.py, cli/tests/test_tui_app.py, cli/tests/test_tui_input.py, cli/tui/app.py |
...
| env.py | — | _truthy, facts_replan, flags, gate3a_replay, gate5b4c3_shadow_counter_store, gate5b4c3_shadow_generation_contract, hosted_defaults, mcp_resilience, models, pregate8_continuity_canary, shadow_generations | (root)/main.py, adk_bridge/anthropic_cache_model.py, adk_bridge/control_plane.py, adk_bridge/dashboard_producer_control.py, adk_bridge/tool_adapter.py, browser/autonomous/config.py, cli/app.py, cli/goal_nudge_wiring.py, cli/headless.py, cli/hook_wiring.py, cli/permissions.py, cli/tests/test_app.py, cli/tool_runtime.py, cli/wiring.py, computer/autonomous/config.py, config/__init__.py, config/tests/test_flag_migration_parity.py, customize/builtin_policy_overrides.py, engine/driver.py, engine/engine_gates.py, engine/engine_recovery.py, engine/engine_user_packs.py, engine/model_runner.py, engine/providers.py, evidence/final_output_gate.py, evidence/local_tool_collector.py, firstparty/packs/workspace_tools_default/impl.py, gates/gate5b_full_toolhost.py, gates/tool_usage_guidance.py, harness/general_automation/constraint_reinjection.py, harness/general_automation/delegation.py, harness/general_automation/live_gate.py, harness/general_automation/plan_act_switch.py, harness/general_automation/question_tool.py, harness/general_automation/recipe_disclosure.py, harness/general_automation/task_completion.py, introspection/tool.py, packs/loader.py, packs/signing.py, plugins/native/deep_solve.py, plugins/native/missions.py, plugins/native/scheduled_work.py, plugins/native/skills.py, plugins/native/taskboard.py, recipes/coding_mutation.py, recipes/compiler.py, recipes/ledger_workforce.py, recipes/recipe_routing.py, runtime/coding_context.py, runtime/error_recovery/types.py, runtime/facts_replan.py, runtime/goal_loop_policy.py, runtime/governed_turn.py, runtime/local_defaults.py, runtime/message_builder.py, runtime/model_factory.py, runtime/model_tiers.py, runtime/openmagi_runtime.py, runtime/prompt_guidance.py, runtime/session_ownership.py, runtime/tool_synthesis.py, shadow/gate5b4c3_live_runner_boundary.py, shadow/gate5b4c3_runner_input_adapter.py, shadow/hosted_session_substrate.py, shadow/session_service_registry.py, tools/ask_user_question_toolhost.py, tools/core_toolhost.py, tools/dispatcher.py, tools/document_tools.py, tools/egress_guard.py, tools/file_tool_manifests.py, tools/file_toolhost.py, tools/image_tools.py, tools/local_readonly.py, tools/plan_mode_toolhost.py, tools/safety.py, tools/user_tool_packs.py, tools/web_search_tools.py, transport/chat.py, transport/chat_routes.py, transport/chat_routes_local.py, transport/chat_shared.py, transport/gate5b_governance.py, transport/gate5b_serving.py, transport/packs_dashboard.py, transport/streaming_chat_route.py |
| flags.py | Canonical feature-flag registry + typed reader (single source of truth). | _truthy | (root)/facades.py, (root)/main.py, adk_bridge/control_plane.py, adk_bridge/event_adapter.py, adk_bridge/runner_adapter.py, adk_bridge/session_service.py, adk_bridge/tool_adapter.py, artifacts/file_delivery_live.py, cli/app.py, cli/headless.py, cli/memory_recall_rerank.py, cli/tui/app.py, cli/tui/tool_render.py, cli/wiring.py, coding/repair_loop.py, composio/config.py, config/env.py, config/serve_token.py, config/tests/test_flag_migration_parity.py, config/tests/test_flags.py, context/hook.py, credentials_admin/approval_resolver.py, credentials_admin/approvals_store.py, credentials_admin/local_vault.py, credentials_admin/store.py, credentials_admin/vault_local.py, credentials_admin/vault_server.py, customize/after_tool_gate.py, customize/apply.py, customize/budgets_apply.py, customize/builtin_policy_overrides.py, customize/lifecycle_audit.py, customize/modes.py, customize/runtime_gate.py, customize/scoped_policy.py, customize/store.py, customize/tool_perm.py, customize/what_menu.py, egress_proxy/config.py, engine/driver.py, engine/engine_gates.py, engine/engine_routing.py, engine/model_runner.py, engine/providers.py, evidence/gate1a_egress_correlation.py, evidence/observed_egress.py, gates/memory_write_readiness.py, gateway/heartbeat_watcher.py, gateway/watchers.py, harness/kernel_roles.py, harness/memory_review.py, harness/memory_session_extract.py, harness/scheduler_executor.py, harness/scheduler_job_execution.py, harness/skill_curator.py, harness/verifier_bus.py, harness/workflow_executor.py, hooks/builtin/prompt_transforms.py, hooks/executors/http_executor.py, hooks/executors/llm_executor.py, hooks/external_config.py, memory/adapters/hipocampus_readonly.py, missions/projector.py, missions/work_queue/board_api.py, missions/work_queue/store.py, observability/api.py, observability/config.py, observability/integration.py, observability/transcript.py, ops/health.py, packs/discovery.py, plugins/native/missions.py, prompt/metrics.py, recipes/kernel_recipe_packs.py, recipes/ledger_orchestrator.py, research/live_audit.py, runtime/child_bash.py, runtime/child_runner_live.py, runtime/deadline.py, runtime/durable_recovery.py, runtime/facts_replan.py, runtime/fork_runner.py, runtime/governed_turn.py, runtime/local_defaults.py, runtime/manual_compaction_context.py, runtime/memory_mode_context.py, runtime/message_builder.py, runtime/model_tiers.py, runtime/session_extract_runtime.py, runtime/stream_fallback.py, runtime/stream_withholding.py, shadow/gate5b4c3_runner_input_adapter.py, storage/channel_message_store.py, storage/durable_checkpoint_store.py, telemetry/trace_context.py, tools/audio_tools.py, tools/document_qa_tools.py, tools/document_write/agentic.py, tools/execution_integrity.py, tools/image_tools.py, tools/python_exec.py, tools/truncation.py, tools/video_tools.py, transport/chat_routes.py, transport/chat_routes_local.py, transport/chat_shared.py, transport/composio_broker.py, transport/customize.py, transport/gate2_sandbox_canary.py, transport/gate5b_serving.py, transport/health.py, transport/sse.py, transport/streaming_chat_route.py, transport/web_dashboard.py, web_acquisition/deep_research_config.py, web_acquisition/research_tools.py |
...
| serve_token.py | Per-install local ``magi serve`` gateway token (P0 security fix). | flags | (root)/main.py, cli/tests/test_app.py, transport/streaming_chat_route.py, transport/web_dashboard.py |
...
| policies.py | POLICIES: named user-intent units, typed model + customize.json CRUD. | store | customize/catalog.py, customize/policy_persist.py, customize/scoped_policy.py, transport/customize.py |
...
| engine_recovery.py | Live retry / continuation / empty-response recovery helpers, pure move out of | empty_response_recovery, env, error_recovery, event_projection, no_tool_finalizer, output_continuation | engine/driver.py, transport/gate5b_serving.py |
...
| Module | Purpose | Depends On | Depended By |
|---|---|---|---|
| __init__.py | — | builtin, contracts, extractors, ledger, types | engine/driver.py, testing/runtime_issuance_support.py |
...
| citation_render.py | Pure render projection for source citations (Wave 3a, design Section 8). | research_final_gate, source_ledger | cli/headless.py, transport/streaming_chat_route.py, transport/streaming_driver.py |
...
| ledger_semantics.py | — | — | — |
| ledger_store.py | Reader + retention for the durable evidence-ledger files. | — | cli/headless.py, customize/live_catalog.py, evidence/local_tool_collector.py, evidence/run_view.py, runtime/durable_checkpoint_emitter.py, runtime/governed_turn.py |
| local_tool_collector.py | — | citation_capture, citation_injection, citation_registry, egress_guard, env, extraction, first_party_activity, injection_detection, ledger, ledger_store, result, source_ledger, types | cli/tests/test_evidence_turn_id_reconciliation.py, cli/tests/test_local_tool_evidence_wiring.py, cli/tests/test_real_runner.py, cli/tests/test_tool_runtime.py, cli/tool_runtime.py, cli/wiring.py, engine/model_runner.py, runtime/child_runner_live.py, tools/dispatcher.py, tools/tests/test_core_toolhost_source_projection.py, transport/streaming_chat_route.py |
...
| Module | Purpose | Depends On | Depended By |
|---|---|---|---|
| __init__.py | Execution-authority kernel and live execution-integrity policy adapter. | — | execution_authority/contracts.py |
...
| journal.py | Durable journal port and fail-closed storage errors. | envelopes, journal_integrity | execution_authority/journal_sqlite.py, tools/execution_integrity.py |
| journal_integrity.py | First-party journal integrity and transactional outbox wire contracts. | envelopes, safety, state_machine | execution_authority/journal.py, execution_authority/journal_sqlite.py, tools/execution_integrity.py |
| journal_sqlite.py | SQLite implementation of the integrity journal and transactional outbox. | envelopes, journal, journal_integrity, migrations, state_machine | tools/execution_integrity.py |
...
### firstparty/packs/deep_solve/

| Module | Purpose | Depends On | Depended By |
|---|---|---|---|
| __init__.py | — | — | — |
| impl.py | First-party DeepSolve tool metadata provider (no privilege, typed-ctx only). | catalog, context, manifest | — |
...
| daemon.py | GatewayDaemon — the supervised asyncio watcher fleet (Track F). | _truthy, health, watchers | (root)/app.py, cli/app.py, gateway/channel_watchers.py, gateway/heartbeat_watcher.py, gateway/watchers.py, ops/health.py |
| heartbeat_watcher.py | U4 -- Heartbeat watcher: periodic quiet self-check agent turn. | child_governed_collector, daemon, flags, governed_turn, turn_context | gateway/watchers.py |
...
| watchers.py | Watcher-fleet builders — COMPOSE the existing always-on blocks (Track F). | _truthy, action_reconciler, channel_watchers, child_governed_collector, child_runner_live, cron_turn_runner_adapter, daemon, driver, flags, goal_judge, governed_turn, heartbeat_watcher, notifier, poll_resilience, projector, runner, scheduled_work, scheduler_job_execution, scheduler_job_store, scheduler_loop_driver, store, telegram_live, turn_context, turn_engine | cli/app.py, gateway/channel_watchers.py, gateway/daemon.py, runtime/durable_recovery.py |
...
| cron_turn_runner_adapter.py | A-driver — CronTurnRunnerAdapter: OpenMagiRunnerAdapter -> CronTurnRunner bridge. | resolved, runner_adapter, scheduler_job_execution | gateway/watchers.py |
...
| integration.py | — | config, core, flags, page, runtime_sink, taxonomy | observability/__init__.py, observability/transcript.py |
...
| _common.py | — | context, policy, result | artifacts/file_delivery_live.py, plugins/agentmemory/tools.py, plugins/native/apify.py, plugins/native/artifacts.py, plugins/native/coding.py, plugins/native/deep_solve.py, plugins/native/documents.py, plugins/native/knowledge.py, plugins/native/missions.py, plugins/native/okf.py, plugins/native/scheduled_work.py, plugins/native/skills.py, plugins/native/source_ledger.py, plugins/native/subagents.py, plugins/native/taskboard.py, tools/document_write/canonical.py, tools/document_write/model.py, tools/document_write/orchestrator.py, tools/document_write_tools.py |
...
| deep_solve.py | DeepSolve native tool handler (U3). | _common, child_runner_boundary, child_runner_live, child_toolset, context, core_toolhost, deep_solve, discovery, env, public_events, result, subagents, templates | — |
...
| child_governed_collector.py | Governed-stream to child-envelope adapter. | child_missing_tool_guard, child_runner_live, contracts, events | channels/turn_engine.py, gateway/heartbeat_watcher.py, gateway/watchers.py, runtime/child_runner_live.py |
| child_missing_tool_guard.py | Child-scoped missing-tool streak guard (Fix F backstop). | — | runtime/child_governed_collector.py, runtime/child_runner_live.py |
| child_runner_boundary.py | — | adk_turn_runner, child_acceptance, child_runtime_envelope, model_tiers, runtime_issuance, subagent, trace_sink | harness/workflow_executor.py, missions/work_queue/runner.py, plugins/native/deep_solve.py, plugins/native/subagents.py, runtime/child_event_projection.py |
| child_runner_live.py | A REAL, model-backed local child runner for the Child Runner boundary. | capability_scope, child_bash, child_derive, child_governed_collector, child_missing_tool_guard, child_toolset, event_adapter, flags, governed_turn, local_tool_collector, model_runner, model_tiers, providers, store, tool_runtime, trace_sink, verification_policy, wiring | channels/turn_engine.py, engine/driver.py, gateway/watchers.py, harness/workflow_executor.py, plugins/native/deep_solve.py, plugins/native/subagents.py, runtime/child_derive.py, runtime/child_governed_collector.py, runtime/child_runner_status.py, runtime/governed_turn.py, runtime/message_builder.py, transport/chat_shared.py, transport/streaming_chat_route.py |
...
| child_toolset.py | Child-runner toolset profile resolution (PR1, doc 07). | child_bash, local_readonly | harness/workflow_executor.py, plugins/native/deep_solve.py, plugins/native/subagents.py, runtime/child_runner_live.py, runtime/child_runner_status.py, runtime/main_agent_profile.py |
...
| hosted_runtime.py | Hosted-runtime foundation for governed-turn serving. | adk_instruction, contracts, driver, wire_profile | transport/chat_routes.py, transport/gate5b_serving.py |
...
| no_tool_finalizer.py | No-tool finalizer: never end a turn blank after a tool loop (B9 backstop). | — | engine/driver.py, engine/engine_recovery.py |
...
| per_turn_goal_intensity.py | Per-turn ``ContextVar`` carrying the auto-continue INTENSITY for a turn. | — | engine/driver.py, transport/chat_routes_local.py, transport/gate5b_serving.py, transport/streaming_chat_route.py |
| per_turn_goal_loop_context.py | Per-turn ``ContextVar`` carrying the active :class:`GoalLoopPolicy`. | goal_loop_policy | engine/driver.py, transport/chat_routes_local.py, transport/gate5b_serving.py, transport/streaming_chat_route.py |
...
| public_events.py | — | — | adk_bridge/event_adapter.py, adk_bridge/wire_profile.py, engine/driver.py, evidence/event_projection.py, gates/gate5b_full_toolhost.py, harness/cross_review.py, harness/workflow_executor.py, meta_orchestration/event_projection.py, plugins/native/deep_solve.py, plugins/native/subagents.py, research/event_projection.py, research/research_first_canary.py, runtime/events.py, runtime/work_console_snapshot.py, shadow/gate5b4c3_live_runner_boundary.py, tools/event_projection.py, transport/chat.py, transport/chat_routes.py, transport/gate5b_serving.py, transport/sse.py, transport/streaming_chat_route.py, transport/streaming_driver.py |
...
| skill_slash.py | Transport-agnostic slash-to-skill resolver for hosted and CLI surfaces. | skills | runtime/tests/test_skill_slash.py, transport/generation_request.py, transport/streaming_chat_route.py |
...
| turn_context.py | Single value object describing one governed turn (top-level or child). | — | channels/turn_engine.py, cli/headless.py, gateway/heartbeat_watcher.py, gateway/watchers.py, runtime/child_derive.py, runtime/governed_turn.py, transport/chat_routes.py, transport/chat_routes_local.py, transport/hosted_turn_context.py |
| turn_maintenance.py | — | — | — |
...
| egress_destinations.py | U2 -- egress destination extraction (pure module, no wiring). | approval_resolver | tools/egress_guard.py |
...
| gate5b4c3_live_runner_boundary.py | — | adk_instruction, env, gate1a_egress_correlation, gate5b4c3_image_parts, gate5b4c3_runner_input_adapter, gate5b4c3_shadow_generation_contract, health, model_factory, output_continuation, public_events, session_ownership, session_service_registry, transcript | transport/chat.py, transport/chat_routes.py, transport/chat_shared.py, transport/gate5b_serving.py, transport/hosted_engine_result.py, transport/hosted_turn_context.py |
...
| gate5b4c3_shadow_generation_contract.py | — | — | config/env.py, runtime/user_visible_model_routing.py, shadow/gate5b4c3_live_runner_boundary.py, shadow/gate5b4c3_runner_input_adapter.py, shadow/gate5b4c3_shadow_generation_report.py, transport/chat.py, transport/chat_routes.py, transport/gate5b_serving.py, transport/generation_request.py, transport/hosted_engine_result.py, transport/hosted_turn_context.py, transport/shadow_generations.py |
| gate5b4c3_shadow_generation_report.py | — | gate5b4c3_shadow_counter_store, gate5b4c3_shadow_generation_contract | — |
| gate5b4d_stream_fixture_audit.py | — | sse | — |
| gate5b_user_visible_routing_canary.py | — | gate4c0_shadow_config | — |
| hosted_session_substrate.py | Durable hosted ADK session substrate (PR-3). | env | runtime/session_ownership.py, transport/gate5b_serving.py |
| redacted_ts_bundle.py | — | fixture_runner | — |
| research_runner_capture.py | — | — | — |
| session_service_registry.py | Process-scope session-service registry for hosted turn reuse (08-PR5). | env | runtime/session_ownership.py, shadow/gate5b4c3_live_runner_boundary.py, transport/local_session_registry.py |
...
| deep_solve.py | Deep-solve orchestrator core (U1) — pure, no network. | templates | plugins/native/deep_solve.py, solving/__init__.py |
| templates.py | Domain prompt templates for the deep-solve pipeline (U1.4). | — | plugins/native/deep_solve.py, solving/__init__.py, solving/deep_solve.py |
...
| channel_message_store.py | Durable per-channel message log for local-serve multi-window history sync. | flags, migrations, session_store | transport/chat_routes_local.py, transport/streaming_chat_route.py |
...
| migrations.py | — | — | harness/goal_state.py, harness/scheduler_job_store.py, missions/work_queue/store.py, storage/channel_message_store.py, storage/session_store.py |
| session_store.py | — | migrations | adk_bridge/session_service.py, learning/bootstrap.py, storage/channel_message_store.py, transport/app_api.py, transport/streaming_chat_route.py |
...
| egress_guard.py | U3 -- egress_guard AUDIT mode wiring (observe-only, NEVER denies). | egress_destinations, env, types | evidence/local_tool_collector.py, tools/permission.py |
| event_projection.py | — | kernel, public_events, tool_boundary, tool_preview | tools/kernel.py |
| execution_integrity.py | Live policy adapter for execution-integrity admission and observations. | context, envelopes, flags, journal, journal_integrity, journal_sqlite, manifest, result | engine/driver.py, tools/dispatcher.py |
| file_markdown.py | Unified file->markdown conversion entry point (delegation-only). | archive_tools, context, document_tools, result, spreadsheet_tools | tools/document_qa_tools.py, transport/app_api.py, transport/kb_context.py |
...
| kernel.py | Evidence-emitting tool execution kernel — default-OFF, not the live hot path. | context, dispatch_shared, event_projection, local_result_store, manifest, output_budget, permission, registry, request_ledger, result, safety, safety_policy_attribution, schema_validation, tool_boundary | runtime/approval_resume.py, tools/event_projection.py, tools/scheduler.py, web_acquisition/reference_research_tools.py |
...
| permission.py | — | approval_resolver, context, control, egress_guard, manifest, safety, tool_perm | firstparty/packs/gates_policy_default/impl.py, gates/gate5b_full_toolhost.py, tools/__init__.py, tools/dispatcher.py, tools/kernel.py |
...
| safety_policy_attribution.py | Attribution mapping from safety.py deny reason codes to system_safety policy members. | — | tools/kernel.py |
...
| app_api.py | Dashboard ``/v1/app/*`` API surface. | config, context, engine, file_markdown, openmagi_runtime, projection, providers, search, session_store, skills, store, tools | (root)/app.py, customize/catalog.py, transport/streaming_chat_route.py |
...
| chat_routes_local.py | Local ADK chat SSE path + background-inject helpers, pure move out of | _truthy, active_sessions, channel_message_store, chat_shared, contracts, env, flags, goal_loop_policy, governed_turn, kb_context, learning_live_readiness, local_session_registry, memory_mode_context, memory_turn_hook, model_runner, modes, openmagi_runtime, per_turn_agent_mode_context, per_turn_goal_intensity, per_turn_goal_loop_context, turn_context, wiring, work_queue | transport/chat_routes.py, transport/gate5b_serving.py |
| chat_shared.py | Shared primitives for the decomposed Gate5B chat serving stack. | _truthy, child_runner_live, env, flags, gate1a_readonly_tools, gate5b4c3_live_runner_boundary, gate5b_full_toolhost, openmagi_runtime, session_identity, shadow_generations, user_visible_model_routing | transport/chat.py, transport/chat_authority.py, transport/chat_routes.py, transport/chat_routes_local.py, transport/control_requests.py, transport/gate2_sandbox_canary.py, transport/gate5b_serving.py, transport/generation_request.py, transport/streaming_chat_route.py |
...
| customize.py | — | apply, budgets_apply, builtin_policy_overrides, catalog, control_plane_overrides, custom_rules, dashboard_authored, discovery, field_constraint_compiler, flags, inventory, live_catalog, mode_compiler, modes, nl_compiler_interactive, nl_policy_interactive, openmagi_runtime, policies, policy_compiler, policy_persist, policy_plan, policy_review, prebuilt_components, rule_compiler, runtime_fields, seam_compiler, seam_spec, shacl_compiler, store, tools, types, wiring | (root)/app.py |
...
| gate5b_serving.py | Gate5B user-visible serving engine, pure move out of | active_turn, chat_authority, chat_routes_local, chat_shared, compiler, config, egress_critic, egress_gate, engine_recovery, env, flags, gate1a_egress_correlation, gate1a_readonly_tools, gate5b4c3_live_runner_boundary, gate5b4c3_runner_input_adapter, gate5b4c3_shadow_generation_contract, gate5b_full_toolhost, gate5b_governance, generation_request, goal_loop_policy, governed_turn, hosted_engine_result, hosted_runtime, hosted_session_substrate, hosted_turn_context, kernel_recipe_packs, materializer, observed_egress, openmagi_runtime, per_turn_goal_intensity, per_turn_goal_loop_context, public_events, research_first_canary, runtime_sink, session_identity, session_ownership, transcript, usage_receipt_emit | transport/chat_routes.py |
| generation_request.py | User-visible generation request, identity, and history contract builders. | chat_shared, gate1a_readonly_tools, gate5b4c3_shadow_generation_contract, gate5b_full_toolhost, message_builder, openmagi_runtime, session_identity, skill_slash, user_visible_model_routing | transport/chat.py, transport/chat_authority.py, transport/chat_routes.py, transport/egress_critic.py, transport/gate5b_serving.py |
...
| streaming_chat_route.py | Hosted-grade SSE streaming-chat HTTP surface. | active_turn, app_api, channel_message_store, chat, chat_shared, child_runner_live, citation_render, contracts, env, events, flags, gate5b_full_toolhost, goal_loop_policy, health, local_session_registry, local_tool_collector, local_turn_pump, local_turn_store, memory_mode_context, modes, per_turn_goal_intensity, per_turn_goal_loop_context, protocol, providers, public_events, serve_token, session_store, skill_slash, streaming_chat, streaming_driver, streaming_sink, usage_cost, wiring | (root)/app.py, cli/tests/test_model_picker_wire.py |
...
| web_dashboard.py | Serve the web dashboard (static Next.js export) — the single dashboard path. | engine, flags, openmagi_runtime, providers, serve_token | (root)/app.py |
