...
| nl_policy_interactive.py | Conversational (multi-turn) POLICY compiler. | custom_rules, dashboard_authored, nl_compiler_interactive, policy_compiler, policy_plan, rule_compiler | — |
...
| policy_compiler.py | Conversational compiler for a multi-rule POLICY (producer + gate + binding). | custom_rules, dashboard_authored, policy_plan, rule_compiler | customize/nl_policy_interactive.py |
| policy_plan.py | Policy-integrity structural checks (the deterministic core of the review loop). | — | customize/nl_policy_interactive.py, customize/policy_compiler.py |
...
| dashboard_authored.py | Compile dashboard-authored custom checks into a single user pack. | compiler, types | adk_bridge/dashboard_producer_control.py, customize/nl_policy_interactive.py, customize/policy_compiler.py, customize/rule_compiler.py, transport/packs_dashboard.py |
