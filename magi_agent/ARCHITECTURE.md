...
| skill_slash.py | Transport-agnostic slash-to-skill resolver for hosted and CLI surfaces. | skills | runtime/tests/test_skill_slash.py, transport/generation_request.py |
