...
| session_service.py | — | flags, session_store | adk_bridge/context_compaction.py, adk_bridge/local_runner.py, cli/session_log.py, engine/model_runner.py |
...
| providers.py | Deprecation alias shim (rem2/F4): canonical home is | engine | (root)/main.py, cli/app.py, cli/commands/control.py, cli/memory_bootstrap.py, cli/tests/test_anthropic_cache_selection.py, cli/tests/test_model_picker_wire.py, cli/tests/test_providers.py, cli/tests/test_real_runner.py, cli/tests/test_runtime_policy_wiring.py, cli/tests/test_tui_dialog_model.py, cli/tui/app.py, cli/tui/dialogs/model.py, cli/wiring.py |
...
| real_runner.py | Deprecation alias shim (rem2/F5): canonical home is | engine | cli/readonly_classifier.py, cli/tests/test_app.py, cli/tests/test_force_recipe_env_wiring.py, cli/tests/test_force_recipe_source_grounded_selection.py, cli/tests/test_real_runner.py, cli/tests/test_runtime_policy_wiring.py, cli/wiring.py |
...
| wiring.py | Composition root for the Magi CLI (PR-F1, Stream F). | app, commands, config, context, contracts, dispatcher, egress_critic, engine, env, file_provider, file_tool_manifests, file_toolhost, first_party_gate, flags, goal_nudge_wiring, hook_wiring, live_gate, local_runner, local_tool_collector, main_agent_profile, manifest, mcp, memory_mode_guard, modes, openmagi_runtime, per_turn_agent_mode_context, permission_scope, permissions, plan_ledger, providers, readonly_classifier, real_runner, registry, runtime_sink, safety, session_identity, session_log, todo_toolhost, tool, tool_adapter, tool_render, tool_runtime, transcript, web | adk_bridge/context_compaction.py, adk_bridge/lifecycle_llm_call_control.py, adk_bridge/lifecycle_session_control.py, cli/app.py, cli/tests/test_app.py, cli/tests/test_coldstart.py, cli/tests/test_plan_mode.py, cli/tests/test_real_runner.py, cli/tests/test_runtime_policy_wiring.py, cli/tests/test_streaming_sink.py, engine/model_runner.py, runtime/child_runner_live.py, runtime/governed_turn.py, transport/chat_routes.py, transport/chat_routes_local.py, transport/customize.py, transport/streaming_chat_route.py |
...
| repair_loop.py | PR6: Bounded Coding Repair Loop. | — | engine/engine_gates.py |
...
| custom_rules.py | Custom verification-rule schema + validation (spec §9.1). | capability_scope, output_rewrite, prompt_injection, shacl_verifier, shell_runner, what_menu | customize/nl_compiler_interactive.py, customize/rule_compiler.py, transport/customize.py |
...
| tool_perm.py | Custom tool-permission rule matching (P2). | flags, scoped_policy, store, verification_policy | customize/runtime_fields.py, tools/permission.py |
...
| contracts.py | Stable interface surface for the Magi headless CLI. | control, events | engine/driver.py, runtime/child_governed_collector.py, runtime/governed_turn.py, transport/chat_routes.py, transport/chat_routes_local.py, transport/hosted_engine_result.py, transport/streaming_chat.py, transport/streaming_chat_route.py, transport/streaming_driver.py |
| driver.py | Real ADK-backed engine driver for the Magi headless CLI (PR-A2). | active_turn_registry, child_runner_live, citation_audit, claim_grounding, context, contracts, criterion_engine, customize_tool_wiring, discipline_boundary, empty_response_recovery, engine_gates, engine_recovery, engine_routing, engine_user_packs, env, error_recovery, event_adapter, event_projection, events, final_output_gate, final_projection_gate, flags, gate5b4c3_image_parts, goal_loop_evidence, goal_loop_judge, goal_nudge, hook_wiring, kernel_recipe_packs, ledger, live_research_final_gate, output_continuation, per_turn_goal_loop_context, permissions, readonly_classifier, recipe_routing, recipes, research_final_gate, runner_adapter, runtime_gate, scoped_policy, sse, store, task_completion, usage_metadata, validator_taxonomy, verification_policy, verifier_bus | engine/engine_gates.py, engine/engine_routing.py, engine/model_runner.py, runtime/hosted_runtime.py |
...
| gate1a_egress_correlation.py | — | flags | evidence/observed_egress.py, gates/gate8_readiness.py, shadow/gate5b4c3_live_runner_boundary.py, transport/chat.py, transport/chat_authority.py, transport/chat_routes.py |
...
| ledger.py | — | authority, builtin, safety, types | engine/driver.py, evidence/__init__.py, evidence/first_party_activity.py, evidence/local_tool_collector.py, harness/general_automation/constraint_reinjection.py, harness/general_automation/live_gate.py, harness/general_automation/task_completion.py, harness/verifier_bus.py, introspection/projection.py, introspection/tool.py, shadow/audit_reporter.py |
| ledger_semantics.py | — | — | — |
...
| observed_egress.py | — | flags, gate1a_egress_correlation | (root)/main.py, transport/chat.py, transport/chat_authority.py, transport/chat_routes.py, transport/health.py |
| reports.py | — | authority, tool_preview, types | evidence/citation_audit.py, evidence/coding_verification.py, evidence/event_projection.py, evidence/source_ledger.py, evidence/subagent.py, observability/audit_view.py, shadow/audit_reporter.py |
| research_final_gate.py | — | authority, citation_audit, source_ledger, types | engine/driver.py, research/live_research_final_gate.py, research/research_first_canary.py |
...
| gate1a_readonly_tools.py | — | _redaction_common, catalog, context, manifest, registry | transport/chat.py, transport/chat_authority.py, transport/chat_routes.py, transport/chat_shared.py, transport/egress_critic.py, transport/generation_request.py |
...
| gate5b_full_toolhost.py | — | _bounded_pipe, _redaction_common, async_shell_runner, code_diagnostics_receipts, coding_tool_receipts, config, context, deadline, dispatcher, edit_match_receipts, edit_matching, env, first_party_gate, formatter_runner, injection, lsp_client, main_agent_profile, manifest, memory_mode_guard, patch_apply, permission, public_events, read_format, read_ledger, registries, registry, result, ripgrep, session_identity, store, tool_usage_guidance | firstparty/packs/gates_policy_default/impl.py, firstparty/packs/workspace_tools_default/impl.py, packs/context.py, tools/core_toolhost.py, tools/tests/test_core_toolhost_source_projection.py, tools/user_tool_packs.py, transport/chat.py, transport/chat_authority.py, transport/chat_routes.py, transport/chat_shared.py, transport/egress_critic.py, transport/generation_request.py, transport/health.py, transport/streaming_chat_route.py |
...
| learning_live_readiness.py | Learning-layer LIVE adapter readiness gate — PR7. | _readiness_common, config | harness/memory_recall.py, harness/memory_write.py, learning/live.py, transport/chat_routes.py, transport/chat_routes_local.py |
...
| egress_gate.py | Evidence-grounded egress critic gate (PR3). | fact_critical, projection, reason_safety | customize/criterion_engine.py, transport/chat.py, transport/chat_authority.py, transport/chat_routes.py, transport/egress_critic.py |
...
| discovery.py | Pack discovery (D1): resolve search-path bases and rglob ``pack.toml``. | flags, manifest | adk_bridge/dashboard_producer_control.py, engine/model_runner.py, evidence/first_party_gate.py, harness/goal_loop_control.py, harness/kernel_roles.py, harness/memory_compaction.py, harness/scheduler_executor.py, packs/catalog_build.py, packs/inventory.py, packs/loader.py, packs/registries.py, packs/signing.py, packs/user_evidence.py, packs/user_validators.py, recipes/kernel_recipe_packs.py, tools/persistent_python_toolhost.py, tools/user_tool_packs.py, transport/packs_dashboard.py |
...
| materializer.py | — | compiler, context_budget, model_tiers, phase_routing, phase_routing_defaults, reliability_budget, reliability_policy | cli/tests/test_source_grounded_recipe_gate_integration.py, engine/model_runner.py, recipes/workflow_recipe.py, transport/chat.py, transport/chat_routes.py |
...
| active_sessions.py | In-process active-session transcript buffer for serve session-end extraction. | session_extract_runtime | (root)/app.py, transport/chat_routes.py, transport/chat_routes_local.py |
...
| durable_recovery.py | WS1 PR1d - StartupRecoverySweep: turn-level boot recovery orchestration. | driver, durable_checkpoint_store, flags, recovery, session_log, store, watchers | cli/app.py |
...
| goal_loop_policy.py | Runtime ``GoalLoopPolicy`` — the per-turn shape PR-C's clean-break judge | — | runtime/goal_loop_judge.py, runtime/per_turn_goal_loop_context.py, transport/chat_routes.py, transport/chat_routes_local.py |
...
| hosted_runtime.py | Hosted-runtime foundation for governed-turn serving. | driver, wire_profile | transport/chat_routes.py |
...
| memory_mode_context.py | Async-safe per-request memory-mode context for the live serve path. | flags, session_identity | cli/headless.py, transport/chat_routes.py, transport/chat_routes_local.py, transport/streaming_chat_route.py |
...
| memory_turn_hook.py | Turn-end memory hook: transcript→daily flush + compaction trigger (PR-B). | compaction_tree, config, local_file_writable, summarizer_runtime | cli/headless.py, transport/chat_routes.py, transport/chat_routes_local.py |
...
| openmagi_runtime.py | — | apply, base, catalog, core_toolhost, env, manager, memory_write_wiring, models, native_catalog, persistent_python_toolhost, primitives, profiles, registry, store, todo_toolhost, tool, tool_projection | (root)/app.py, (root)/main.py, cli/tests/test_model_picker_wire.py, cli/wiring.py, transport/app_api.py, transport/chat.py, transport/chat_authority.py, transport/chat_routes.py, transport/chat_routes_local.py, transport/chat_shared.py, transport/control_requests.py, transport/credentials.py, transport/customize.py, transport/gate2_sandbox_canary.py, transport/generation_request.py, transport/health.py, transport/integrations.py, transport/learning_dashboard.py, transport/plugins.py, transport/product_admin.py, transport/shadow_invocations.py, transport/tools.py, transport/web_dashboard.py |
...
| per_turn_agent_mode_context.py | Per-turn ``ContextVar`` carrying the request-selected agent MODE id. | — | cli/wiring.py, customize/modes.py, customize/scoped_policy.py, runtime/message_builder.py, transport/chat_routes.py, transport/chat_routes_local.py |
| per_turn_goal_loop_context.py | Per-turn ``ContextVar`` carrying the active :class:`GoalLoopPolicy`. | goal_loop_policy | engine/driver.py, transport/chat_routes.py, transport/chat_routes_local.py |
...
| session_identity.py | — | — | cli/tool_runtime.py, cli/wiring.py, engine/model_runner.py, gates/gate5b_full_toolhost.py, runtime/memory_mode_context.py, tools/context.py, tools/memory_mode_guard.py, transport/chat.py, transport/chat_routes.py, transport/chat_shared.py, transport/generation_request.py |
...
| customize.py | — | apply, budgets_apply, catalog, control_plane_overrides, custom_rules, field_constraint_compiler, flags, inventory, live_catalog, mode_compiler, modes, nl_compiler_interactive, openmagi_runtime, prebuilt_components, rule_compiler, runtime_fields, seam_compiler, seam_spec, shacl_compiler, store, tools, types, wiring | (root)/app.py |
...
| streaming_chat_route.py | Hosted-grade SSE streaming-chat HTTP surface. | active_turn, app_api, chat, child_runner_live, contracts, env, events, flags, gate5b_full_toolhost, health, memory_mode_context, modes, protocol, providers, public_events, session_store, streaming_chat, streaming_driver, streaming_sink, usage_cost, wiring | (root)/app.py, cli/tests/test_model_picker_wire.py |
