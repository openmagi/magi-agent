...
| flags.py | Canonical feature-flag registry + typed reader (single source of truth). | env | config/env.py, config/tests/test_flags.py, tools/image_tools.py, tools/python_exec.py |
