...
| gate1a_readonly_tools.py | — | _redaction_common, _workspace_path_guards, catalog, context, manifest, registry | transport/chat.py, transport/chat_authority.py, transport/chat_routes.py, transport/chat_shared.py, transport/egress_critic.py, transport/generation_request.py |
