...
| deep_solve.py | DeepSolve native tool handler (U3). | _common, child_runner_boundary, child_runner_live, child_toolset, context, core_toolhost, deep_solve, env, public_events, result, subagents, templates | — |
