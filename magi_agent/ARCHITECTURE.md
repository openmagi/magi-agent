...
| compiler.py | — | discovery, env, learning_usage | cli/real_runner.py, cli/tests/test_force_recipe_source_grounded_selection.py, cli/tests/test_source_grounded_recipe_gate_integration.py, cli/tool_runtime.py, packs/registries.py, recipes/__init__.py, recipes/first_party/discovery.py, recipes/first_party/learning_usage.py, recipes/materializer.py, recipes/recipe_routing.py, recipes/workflow_recipe.py, shadow/gate2_recipe_profile_resolver.py, shadow/mission_lifecycle_contract.py, transport/chat.py, transport/chat_routes.py |
...
| recipe_routing.py | Cross-family description-based recipe routing — generalizes the GA-only | compiler, context, env, manifest, recipe_routing_constants, registry, result | cli/tool_runtime.py |
