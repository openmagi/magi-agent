...
| store.py | — | — | cli/real_runner.py, customize/__init__.py, customize/runtime_gate.py, runtime/openmagi_runtime.py, transport/customize.py |
...
| discovery.py | Pack discovery (D1): resolve search-path bases and rglob ``pack.toml``. | flags, manifest | cli/real_runner.py, evidence/first_party_gate.py, harness/goal_loop_control.py, harness/memory_compaction.py, harness/scheduler_executor.py, packs/catalog_build.py, packs/loader.py, packs/registries.py, tools/persistent_python_toolhost.py |
...
| compiler.py | — | discovery, env, learning_usage | cli/real_runner.py, cli/tests/test_force_recipe_source_grounded_selection.py, cli/tests/test_runtime_policy_wiring.py, cli/tests/test_source_grounded_recipe_gate_integration.py, cli/tool_runtime.py, packs/registries.py, recipes/__init__.py, recipes/first_party/discovery.py, recipes/first_party/learning_usage.py, recipes/materializer.py, recipes/recipe_routing.py, recipes/workflow_recipe.py, shadow/gate2_recipe_profile_resolver.py, shadow/mission_lifecycle_contract.py, transport/chat.py, transport/chat_routes.py |
...
| recipe_routing.py | Cross-family description-based recipe routing — generalizes the GA-only | compiler, context, env, manifest, recipe_routing_constants, registry, result | cli/real_runner.py, cli/tool_runtime.py |
...
| message_builder.py | — | bus, child_runner_live, context, env, injection, manifest, model_tiers, provider_adapter, resolved, splitter | cli/clipboard_image.py, cli/tool_runtime.py, runtime/context_attachments.py, shadow/gate5b4c3_runner_input_adapter.py, transport/chat.py, transport/generation_request.py |
