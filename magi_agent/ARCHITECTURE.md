...
| child_governed_collector.py | Governed-stream to child-envelope adapter. | child_runner_live, contracts, events | channels/turn_engine.py, gateway/heartbeat_watcher.py, gateway/watchers.py, runtime/child_runner_live.py |
...
| child_runner_live.py | A REAL, model-backed local child runner for the Child Runner boundary. | capability_scope, child_bash, child_derive, child_governed_collector, child_toolset, event_adapter, flags, governed_turn, local_tool_collector, model_runner, model_tiers, providers, store, tool_runtime, trace_sink, verification_policy, wiring | channels/turn_engine.py, engine/driver.py, gateway/watchers.py, harness/workflow_executor.py, plugins/native/deep_solve.py, plugins/native/subagents.py, runtime/child_derive.py, runtime/child_governed_collector.py, runtime/child_runner_status.py, runtime/governed_turn.py, runtime/message_builder.py, transport/chat_shared.py, transport/streaming_chat_route.py |
