...
| execution_integrity.py | Live policy adapter for execution-integrity admission and observations. | context, envelopes, journal, journal_integrity, journal_sqlite, manifest, result | engine/driver.py, tools/dispatcher.py |
