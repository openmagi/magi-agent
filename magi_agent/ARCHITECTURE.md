...
| goal_loop_policy.py | Runtime ``GoalLoopPolicy`` — the per-turn shape PR-C's clean-break judge | env | runtime/goal_loop_judge.py, runtime/per_turn_goal_loop_context.py, transport/chat_routes_local.py |
