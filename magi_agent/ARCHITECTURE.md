...
| Module | Purpose | Depends On | Depended By |
|---|---|---|---|
| __init__.py | Magi headless CLI foundation (PR-A1). | — | browser/autonomous/tool.py, cli/app.py, cli/tests/test_anthropic_cache_selection.py, cli/tests/test_app.py, cli/tests/test_model_picker_wire.py, transport/app_api.py |
