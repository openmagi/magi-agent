...
| manager.py | — | manifest | plugins/audit.py, runtime/openmagi_runtime.py, transport/plugins.py |
| manifest.py | — | sandbox_policy | connectors/marketplace.py, plugins/__init__.py, plugins/audit.py, plugins/manager.py, plugins/native_catalog.py, plugins/sandbox_policy.py |
...
| tool_projection.py | — | — | runtime/openmagi_runtime.py |
