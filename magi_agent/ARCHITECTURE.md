...
| final_output_gate.py | — | calculation_policy, env, evidence_first_projection, gate_activation, model_tiers, uncertainty_policy | cli/engine.py, harness/long_context_eval.py, runtime/goal_nudge.py |
