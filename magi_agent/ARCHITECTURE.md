...
| streaming_chat_route.py | Hosted-grade SSE streaming-chat HTTP surface. | active_turn, chat, contracts, env, events, health, memory_mode_context, protocol, streaming_chat, streaming_driver, streaming_sink, taskkind_classifier, wiring, workflow_classifier_live, workflow_confirm_store, workflow_gate, workflow_orchestrator | (root)/app.py |
