...
| dashboard_authored.py | Compile dashboard-authored custom checks into a single user pack. | compiler, types | adk_bridge/dashboard_producer_control.py, customize/rule_compiler.py, transport/packs_dashboard.py |
