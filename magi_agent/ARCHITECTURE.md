...
| control_plane.py | ADK loop control-plane abstraction (PR2, goose-parity). | constraint_reinjection, context_compaction, edit_retry_reflection, env, facts_replan_control, fork_runner, manifest, resilience_plugin, self_review, tool_synthesis, tool_synthesis_nudge, turn_policy | adk_bridge/facts_replan_control.py, adk_bridge/local_runner.py, cli/real_runner.py, cli/tests/test_real_runner.py |
