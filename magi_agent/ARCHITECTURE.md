...
| flags.py | Canonical feature-flag registry + typed reader (single source of truth). | _truthy | (root)/main.py, adk_bridge/control_plane.py, adk_bridge/event_adapter.py, cli/engine.py, cli/headless.py, cli/real_runner.py, cli/tui/app.py, cli/tui/tool_render.py, cli/wiring.py, config/env.py, config/tests/test_flag_migration_parity.py, config/tests/test_flags.py, context/hook.py, credentials_admin/vault_local.py, customize/after_tool_gate.py, customize/apply.py, customize/runtime_gate.py, customize/tool_perm.py, customize/what_menu.py, gateway/watchers.py, harness/kernel_roles.py, harness/verifier_bus.py, missions/work_queue/board_api.py, missions/work_queue/store.py, observability/config.py, observability/transcript.py, packs/discovery.py, plugins/native/missions.py, recipes/kernel_recipe_packs.py, research/live_audit.py, runtime/child_runner_live.py, runtime/error_recovery/types.py, runtime/fork_runner.py, runtime/message_builder.py, runtime/stream_withholding.py, shadow/gate5b4c3_live_runner_boundary.py, shadow/gate5b4c3_runner_input_adapter.py, tools/audio_tools.py, tools/document_qa_tools.py, tools/document_write/agentic.py, tools/image_tools.py, tools/python_exec.py, tools/video_tools.py, transport/chat_routes.py, transport/customize.py, transport/health.py, transport/streaming_chat_route.py |
