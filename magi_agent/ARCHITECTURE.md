...
| gate1a_readonly_tools.py | — | _redaction_common, catalog, context, manifest, registry | transport/chat.py, transport/chat_authority.py, transport/chat_routes.py, transport/chat_shared.py, transport/egress_critic.py, transport/gate5b_serving.py, transport/generation_request.py |
...
| gate5b_serving.py | Gate5B user-visible serving engine, pure move out of | active_turn, chat_authority, chat_routes_local, chat_shared, compiler, egress_critic, egress_gate, env, flags, gate1a_egress_correlation, gate1a_readonly_tools, gate5b4c3_live_runner_boundary, gate5b4c3_runner_input_adapter, gate5b4c3_shadow_generation_contract, gate5b_full_toolhost, gate5b_governance, generation_request, governed_turn, hosted_engine_result, hosted_runtime, hosted_turn_context, kernel_recipe_packs, materializer, observed_egress, openmagi_runtime, public_events, research_first_canary, session_identity, usage_receipt_emit | — |
