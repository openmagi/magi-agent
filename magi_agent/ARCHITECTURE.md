...
| policy_plan.py | Policy-integrity structural checks (the deterministic core of the review loop). | — | customize/nl_policy_interactive.py, customize/policy_compiler.py, customize/policy_persist.py |
...
| dashboard_authored.py | Compile dashboard-authored custom checks into a single user pack. | compiler, types | adk_bridge/dashboard_producer_control.py, customize/nl_policy_interactive.py, customize/policy_compiler.py, customize/policy_persist.py, customize/rule_compiler.py, transport/packs_dashboard.py |
