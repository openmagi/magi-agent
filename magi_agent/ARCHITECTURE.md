...
| chat_routes_local.py | Local ADK chat SSE path + background-inject helpers, pure move out of | _truthy, active_sessions, chat_shared, contracts, env, flags, goal_loop_policy, governed_turn, kb_context, learning_live_readiness, memory_mode_context, memory_turn_hook, model_runner, modes, openmagi_runtime, per_turn_agent_mode_context, per_turn_goal_intensity, per_turn_goal_loop_context, turn_context, wiring, work_queue | transport/chat_routes.py, transport/gate5b_serving.py |
