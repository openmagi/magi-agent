...
| __main__.py | — | main | — |
| app.py | — | app_api, board_api, bootstrap, chat, config, control_requests, credentials, customize, debug_trace, health, integrations, learning_dashboard, observability, openmagi_runtime, packs_dashboard, plugins, shadow_invocations, streaming_chat_route, tools, web_dashboard | (root)/main.py |
...
|---|---|---|---|
| __init__.py | — | — | — |
| test_flag_migration_parity.py | Parity tests for the I-1 batch 1 flag migration (8 ``is_*_enabled`` flags). | env, flags | — |
...
| skill_curator.py | C3 — SkillCurator: inactivity-triggered janitor for agent-authored learned items. | authority, store, types | — |
...
| summarizer_runtime.py | Production cheap-model summarizer for the compaction tree (PR2). | config, providers, real_runner, summarizer_runtime | runtime/memory_turn_hook.py |
